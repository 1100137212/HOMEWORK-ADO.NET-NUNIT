...
<body>
    ...
    <div>
        ...
        <hr />
        學號:<asp:TextBox ID="student_id" runat="server"></asp:TextBox>
        姓名:<asp:TextBox ID="name" runat="server"></asp:TextBox>
        <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" Text="新增" />


        <br />
        ID:<asp:TextBox ID="ID_E" runat="server"></asp:TextBox>
        student_id:<asp:TextBox ID="student_id_E" runat="server"></asp:TextBox>
        Name:<asp:TextBox ID="name_E" runat="server"></asp:TextBox>
